...
contract Deposit {
    ...
    modifier onlyLotteryContract() {
        require(
            msg.sender == lotteryContractAddress,
            "Caller is not the lottery contract"
        );
        _;
    }
